...
function goTo(index) {
  ...
  if (current === 1) resizeCanvas();
  if (current === 2) resizeSlide4();
  if (current === 3) resizeSlide5();
  if (current === 6) resizeSlide8();
  if (current === 7) resizeSlide9();
  if (current === 9) resizeSlide11();
  if (current === 11) resizeSlide13();
  if (current === 12) resizeSlide14();
  if (current === 14) resizeSlide16();
  if (current === 15) resizeSlide17();
  if (current === 18) resizeSlide20();
  if (current === 21) { resizeSlide23(); preloadPianoSamples(); }
  if (current === 23) resizeSlide25();
  if (current === 25) { resizeSlide28(); fsStopAll(); fsActiveHarmonics = 0; updateFsTable(); }
  if (current === 26) resizeSlide27();
  if (current === 27) resizeSlide29();
  if (current === 29) resizeSlide31();
  if (current === 30) resizeSlide32();
  if (current === 31) resizeSlide33();
  if (current === 32) { resizeSlide34(); drawSlide34(); }
  if (current === 33) resizeSlide35();
  if (current === 34) resizeSlide36();
  if (current === 35) resizeSlide37();
  if (current === 36) resizeSlide38();
  if (current === 37) { resizeSlide39(); phInitPhases(); }
  if (current === 38) resizeSlide40();
  if (current === 40) resizeSlide42();
  if (current === 41) resizeSlide43();
  if (current === 42) resizeSlide44();
  if (current === 43) resizeSlide45();
  if (current === 44) resizeSlide46();
  if (current === 45) resizeSlide47();
  if (current === 46) resizeSlide48();
  if (current === 47) resizeSlide49();
}
